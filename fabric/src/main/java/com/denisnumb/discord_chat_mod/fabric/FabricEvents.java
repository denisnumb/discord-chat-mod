...
public class FabricEvents {
    ...
    public static void onAdvancementMade(ServerPlayer player, AdvancementHolder advancementHolder){
        MinecraftEvents.handleAdvancementMade(player, advancementHolder);
    }
