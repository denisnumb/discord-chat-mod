...
import static com.denisnumb.discord_chat_mod.chat_style.CustomChatTypeRegistry.getParametersByChatType;
...
public class MinecraftChatStyleProvider {
    ...
    public static Optional<Component> getStyledAdvancementMessage(Player player, Advancement advancement, String title, String description){
        ...
        String messageStringTemplate = displayInfo.getFrame() == FrameType.TASK
        ...
        String translationKey = displayInfo.getFrame() == FrameType.TASK
                ? ADVANCEMENT_TASK
                : displayInfo.getFrame() == FrameType.GOAL
                ? ADVANCEMENT_GOAL
