...
public class CustomChatTypeRegistry {
    ...
    public static void registerChatTypes(Registry<ChatType> registry) {
        CHAT = ResourceKey.create(Registries.CHAT_TYPE, new ResourceLocation(MOD_ID, CHAT_PATH));
        Registry.register(registry, CHAT, buildChatType(CHAT));

        SAY_COMMAND = ResourceKey.create(Registries.CHAT_TYPE, new ResourceLocation(MOD_ID, SAY_COMMAND_PATH));
        Registry.register(registry, SAY_COMMAND, buildChatType(SAY_COMMAND));

        EMOTE_COMMAND = ResourceKey.create(Registries.CHAT_TYPE, new ResourceLocation(MOD_ID, EMOTE_COMMAND_PATH));
        Registry.register(registry, EMOTE_COMMAND, buildChatType(EMOTE_COMMAND));

        MSG_COMMAND_INCOMING = ResourceKey.create(Registries.CHAT_TYPE, new ResourceLocation(MOD_ID, MSG_COMMAND_INCOMING_PATH));
        Registry.register(registry, MSG_COMMAND_INCOMING, buildChatType(MSG_COMMAND_INCOMING));

        MSG_COMMAND_OUTGOING = ResourceKey.create(Registries.CHAT_TYPE, new ResourceLocation(MOD_ID, MSG_COMMAND_OUTGOING_PATH));
        Registry.register(registry, MSG_COMMAND_OUTGOING, buildChatType(MSG_COMMAND_OUTGOING));

        TEAM_MSG_COMMAND_INCOMING = ResourceKey.create(Registries.CHAT_TYPE, new ResourceLocation(MOD_ID, TEAM_MSG_COMMAND_INCOMING_PATH));
        Registry.register(registry, TEAM_MSG_COMMAND_INCOMING, buildChatType(TEAM_MSG_COMMAND_INCOMING));

        TEAM_MSG_COMMAND_OUTGOING = ResourceKey.create(Registries.CHAT_TYPE, new ResourceLocation(MOD_ID, TEAM_MSG_COMMAND_OUTGOING_PATH));
    ...
    public static ChatType.Bound buildBound(
        ...
        return new ChatType.Bound(registryAccess.registryOrThrow(Registries.CHAT_TYPE).getOrThrow(chatType),
                sender,
                originalMessage
        );
    }
