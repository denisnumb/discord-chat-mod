...
import static com.denisnumb.discord_chat_mod.discord.DiscordUtils.sendDiscordMessage;
    ...
    private static @NotNull List<Component> prepareComponents(Message message) {
        ...
        Component userNameComponent = Component.empty()
                .append(Component.literal(userName)
                        .withStyle(style ->
                                style.withColor(TextColor.parseColor(ColorUtils.getHexColor(roleColor)))
