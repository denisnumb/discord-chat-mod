...
If you don't have a Discord bot, use the [**SETUP GUIDE**](https://github.com/denisnumb/discord-minecraft-chat/blob/neoforge-1.21.1/SETUP_GUIDE.md)
...
For the following functions to work, it is enough to install the mod only on the server side
